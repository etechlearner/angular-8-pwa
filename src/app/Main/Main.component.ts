...
export class MainComponent implements OnInit {
	...
	addRemoveHeaderClass  () {
		setTimeout(()=>{
			if((this.currentUrl != '/session/comingsoon') && (this.currentUrl != '/session/maintenance') && (this.currentUrl != '/login') && (this.currentUrl != '/signup')) {
	...
	addRemoveFooterClass () {
		setTimeout(()=>{
			if((this.currentUrl != '/signup') && (this.currentUrl != '/session/comingsoon') && (this.currentUrl != '/session/maintenance') && (this.currentUrl != '/login') && (this.currentUrl != '/session/signup2')) {
				if(this.currentUrl=='/home'){
